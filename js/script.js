...
async function searchAPIData(endpoint) {
	...
	const response = await fetch(`${API_URL}search/${global.search.type}?api_key=${API_KEY}&language=en-UK&query=${global.search.term}&page=${global.search.page}`);
...
// Create & display pagination for search functionality
